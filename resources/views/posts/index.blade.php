            ...
            <div class="flex flex-col items-center my-6 xl:flex-row gap-x-12 xl:mb-12">
                <div class="pt-6">
                    ...
                    <h2 class="text-lg prose text-gray-400">
                        Welcome to my portfolio - I am a backend developer who love bringing ideas to life. In my free time, I like developing <a href="/projects">side projects</a> and<a href="/posts"> blogging </a>about them. Have a good read!
                    </h2>
                </div>
